...
// Home-screen icon for iOS: the logogram on white, with the padding iOS
// expects so the mark is not cropped by the rounded mask.
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: "#ffffff" }}>
        <svg width="112" height="115" viewBox="0 0 40 41">
          <path
